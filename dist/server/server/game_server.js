"use strict";
var defineClass = require("../shared/util").defineClass;
var proxyMethodsTo = require("../shared/util").proxyMethodsTo;
var World = require("../shared/world")["default"];
var NetworkServer = require("./network_server")["default"];
var EventManager = require("../shared/event_manager")["default"];

var worldMethods = ['getEntity', 'add', 'remove', 'set', 'get', 'createEntity'];

exports["default"] = defineClass(function(){}, {
